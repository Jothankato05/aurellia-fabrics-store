...
<template>
  <footer class="my-5 flex items-center justify-between gap-3 px-5 text-[13px] font-semibold text-secondary-text dark:text-secondary-text-d">
    <div class="truncate">
      <span>&copy; {{ new Date().getFullYear() }} Aurellia Fabrics</span>
      <span class="mx-2">—</span>
      <a class="transition-all hover:text-black hover:dark:text-neutral-100" href="https://www.instagram.com/aurelia_fabrics_" target="_blank" rel="noopener">
        @aurelia_fabrics_
      </a>
    </div>
