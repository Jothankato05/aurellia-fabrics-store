...
useSeoMeta({
  ...
  twitterSite: '@aurelia_fabrics_',
  twitterCreator: '@aurelia_fabrics_',
  keywords: `${name}, Nigerian fabrics, Ankara, lace, Aso-oke, Adire, African print, textile, fabric shop Nigeria`,
